...
```text
/path/to/moviepilot-custom-plugins/p115strgmsub
  -> /app/app/plugins/p115strgmsub
```
...
```bash
mkdir -p /path/to/moviepilot-custom-plugins
...
grep -n 'plugin_version' \
  /path/to/moviepilot-custom-plugins/p115strgmsub/__init__.py | head
```
...
```yaml
- '/path/to/moviepilot-custom-plugins/p115strgmsub:/app/app/plugins/p115strgmsub'
```
